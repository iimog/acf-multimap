...
class acf_field_multimap extends acf_field {
	...
	*/
	...
	function __construct( $settings ) {
		...
		*  var message = acf._e('multimap', 'error');
		*/
		
		$this->l10n = array(
			'error'	=> __('Error! Please enter a higher value', 'acf-multimap'),
		);
	...
	function render_field_settings( $field ) {
		...
		*/
		...
		acf_render_field_setting( $field, array(
			'label'			=> __('Font Size','acf-multimap'),
			'instructions'	=> __('Customise the input font size','acf-multimap'),
			'type'			=> 'number',
			'name'			=> 'font_size',
			'prepend'		=> 'px',
		));
	...
	*/
	...
	function validate_value( $valid, $value, $field, $input ){
		...
		if( $value < $field['custom_minimum_setting'] )
		{
			$valid = __('The value is too little!','acf-multimap'),
		}
